...
<td style="font-size:12px" width="99%" align="center">
	...
	<input type="submit" name="submitBtn" value="投票" class="button"/>	
	&nbsp;<input type="reset" value="重选" class="button"/>
</td>
</tr>
</table>
...
<div style="text-align: center; padding-top: 10px;">
	Powered By <a href="http://www.guzz.org/" target="_blank">Guzz Framework</a>
</div>
