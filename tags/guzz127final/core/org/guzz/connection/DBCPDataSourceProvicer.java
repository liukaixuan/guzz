 ...
 */
public class DBCPDataSourceProvicer implements DataSourceProvicer{
	private static transient final Log log = LogFactory.getLog(DBCPDataSourceProvicer.class) ;
